...
extern "C"
void Bool(const int m, const int n, const int k, Bool *d_A, Bool *d_B, Bool *d_C){
    ...
    Bool_kernel<BLOCK_SIZE_M, BLOCK_SIZE_K, BLOCK_SIZE_N, THREAD_SIZE_M, THREAD_SIZE_N, ENABLE_DOUBLE_BUFFER> 
