...
int main() {
    ...
    cudaMemcpy(h_D, d_C, m * n * sizeof(bool), cudaMemcpyDefault);
...
// but in this script, we did not use any bool4 type of some thing like that, it will be great to try to write a julia version of it
// extern "C"
// void SGemmMatMul(const int m, const int n, const int k, const int BM, const int BN, const int BK, const int TM, const int TN, bool *d_A, bool *d_B, bool *d_C){
