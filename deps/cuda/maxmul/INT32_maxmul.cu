...
#define TYPE int
#define FUNCNAME INT32_maxmul
#define kernel_TT INT32_maxmul_TT
#define kernel_TN INT32_maxmul_TN
#define kernel_NT INT32_maxmul_NT
#define kernel_NN INT32_maxmul_NN
