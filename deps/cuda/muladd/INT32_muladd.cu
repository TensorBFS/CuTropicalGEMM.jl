...
#define TYPE int
#define FUNCNAME INT32_plusmul
#define kernel_TT INT32_plusmul_TT
#define kernel_TN INT32_plusmul_TN
#define kernel_NT INT32_plusmul_NT
#define kernel_NN INT32_plusmul_NN
