...
void FP32_maxmul(const int m, const int n, const int k, float *d_A, float *d_B, float *d_C){
    ...
    FP32_maxmul_kernel<BLOCK_SIZE_M, BLOCK_SIZE_K, BLOCK_SIZE_N, THREAD_SIZE_M, THREAD_SIZE_N, ENABLE_DOUBLE_BUFFER> 
...
void FP64_maxmul(const int m, const int n, const int k, double *d_A, double *d_B, double *d_C){
    ...
    FP64_maxmul_kernel<BLOCK_SIZE_M, BLOCK_SIZE_K, BLOCK_SIZE_N, THREAD_SIZE_M, THREAD_SIZE_N, ENABLE_DOUBLE_BUFFER> 
        <<< dimGrid, dimBlock >>>(d_A, d_B, d_C, m, n, k);
...
void INT32_maxmul(const int m, const int n, const int k, int *d_A, int *d_B, int *d_C){
    ...
    INT32_maxmul_kernel<BLOCK_SIZE_M, BLOCK_SIZE_K, BLOCK_SIZE_N, THREAD_SIZE_M, THREAD_SIZE_N, ENABLE_DOUBLE_BUFFER> 
        <<< dimGrid, dimBlock >>>(d_A, d_B, d_C, m, n, k);
...
void INT64_maxmul(const int m, const int n, const int k, long *d_A, long *d_B, long *d_C){
    ...
    INT64_maxmul_kernel<BLOCK_SIZE_M, BLOCK_SIZE_K, BLOCK_SIZE_N, THREAD_SIZE_M, THREAD_SIZE_N, ENABLE_DOUBLE_BUFFER> 
        <<< dimGrid, dimBlock >>>(d_A, d_B, d_C, m, n, k);
}
